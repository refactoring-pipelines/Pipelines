...
namespace Refactoring.Pipelines
{
    ...
    public class AppliedPipes<TInput1, TInput2> : Sender<List<Tuple<TInput1, TInput2>>>, IGraphNodeWithOutput
    {
        ...
        public AppliedPipes(ISender<TInput1> sender1, ISender<IEnumerable<TInput2>> sender2) : this()
        {
            _sender1 = sender1;
            _sender2 = sender2;
