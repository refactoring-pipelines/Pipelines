...
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L171-L175) / [anchor](#snippet-joined_pipeline)</sup>
<!-- endsnippet -->
...
var to = new[] {1, 2};
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L198-L201) / [anchor](#snippet-applyto_inputs)</sup>
<!-- endsnippet -->
...
var result = "[(#, 1), (#, 2)]";
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L203-L205) / [anchor](#snippet-applyto_outputs)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L208-L210) / [anchor](#snippet-applyto_manual)</sup>
<!-- endsnippet -->
...
var with = new[] {3, 4};
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L231-L234) / [anchor](#snippet-concatwith_inputs)</sup>
<!-- endsnippet -->
...
var result = "[1, 2, 3, 4]";
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L236-L238) / [anchor](#snippet-concatwith_outputs)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L241-L243) / [anchor](#snippet-concatwith_manual)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/Refactoring.Pipelines.Test/PipelineTests.cs#L269-L272) / [anchor](#snippet-process_lambda)</sup>
<!-- endsnippet -->
